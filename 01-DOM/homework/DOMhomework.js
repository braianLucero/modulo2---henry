...
// Tu código acá:
let nam = document.querySelector("#createdBy") 
 nam.innerHTML +=  "brian lucero";      
...
function displayToDos() {
  // Tu código acá:
    ...
    let buildesToDos = buildToDos(toDoItems);
    for (let i = 0; i < buildesToDos.length; i++) {
        toDoContainer.appendChild(buildesToDos[i]);
    }
